...
const GUIDES = [
  {
    category: 'תמחור',
    categoryColor: 'bg-[#e8f0fb] text-[#0066cc]',
  ...
  {
    category: 'עסקים',
    categoryColor: 'bg-[#f5f5f7] text-[#7a7a7a] border border-[#e0e0e0]',
...
export default function PilotsPage() {
  return (
    <main>
      ...
      {/* ── Hero ── */}
      <section className="relative bg-[#272729] overflow-hidden">
        {/* Radar texture */}
        <div className="absolute inset-0 flex items-center justify-end pointer-events-none opacity-[0.06]" aria-hidden="true">
          <svg width="700" height="500" viewBox="0 0 700 500" fill="none" className="-ml-20">
            <circle cx="600" cy="250" r="380" stroke="#0066cc" strokeWidth="1" />
            <circle cx="600" cy="250" r="260" stroke="#0066cc" strokeWidth="0.9" />
            <circle cx="600" cy="250" r="160" stroke="#0066cc" strokeWidth="0.8" />
            <circle cx="600" cy="250" r="80" stroke="#0066cc" strokeWidth="0.7" strokeDasharray="5 3" />
            <line x1="200" y1="250" x2="700" y2="250" stroke="#0066cc" strokeWidth="0.5" />
            <line x1="600" y1="0" x2="600" y2="500" stroke="#0066cc" strokeWidth="0.5" />
          </svg>
        </div>

        <div className="relative max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <span className="inline-block mb-5 px-3 py-1.5 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#2997ff] bg-white/5 border border-white/10 rounded-full">
            מרכז טייסים
          </span>
          <h1 className="text-[2.4rem] sm:text-[3rem] lg:text-[3.8rem] font-semibold text-white leading-[1.05] tracking-[-0.03em] mb-5 max-w-3xl">
            המרכז המקצועי<br />
            לטייסי רחפנים{' '}
            <span className="text-[#0066cc]">בישראל</span>
          </h1>
          <p className="t-lead-airy text-white/60 mb-10 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/add-listing"
              className="px-7 py-3.5 bg-[#0066cc] hover:bg-[#1650e8] text-white text-[14px] font-bold rounded-full transition-colors text-center"
            >
              הוסף את העסק שלך
            </Link>
            <a
              href="#tools"
              className="px-7 py-3.5 border border-white/20 hover:border-white/40 hover:bg-white/5 text-white text-[14px] font-semibold rounded-full transition-colors text-center"
            >
              גלה כלים
            </a>
          </div>
      ...
      <section className="bg-[#f5f5f7] py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-[11px] font-semibold tracking-[0.22em] text-[#0066cc] uppercase mb-2">
              למה אלטיב
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {VALUE_CARDS.map((card) => (
              <div
                key={card.title}
                className="bg-white rounded-[18px] p-6 border border-[#e0e0e0] flex flex-col gap-4"
              >
                <div className="w-10 h-10 rounded-xl bg-[#e8f0fb] flex items-center justify-center text-[#0066cc] shrink-0">
                  {card.icon}
                </div>
                <div>
                  <h3 className="text-[15px] font-bold text-[#1d1d1f] mb-1.5 leading-snug">
                    {card.title}
                  </h3>
      ...
      {/* ── Tools grid ── */}
      <section id="tools" className="bg-white py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-[#1d1d1f] tracking-tight">כלים מקצועיים</h2>
              <p className="text-sm text-[#7a7a7a] mt-1">כל הכלים שצריך לנהל ולצמח את עסק הרחפנים</p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {TOOLS.map((tool) => (
              <div
                key={tool.title}
                className="group relative bg-white rounded-[18px] p-6 border border-[#e0e0e0] flex gap-4 items-start"
              >
                <div className="w-10 h-10 rounded-xl bg-[#f5f5f7] border border-[#e0e0e0] flex items-center justify-center text-[#7a7a7a] shrink-0">
                  {tool.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    <h3 className="text-[14px] font-bold text-[#1d1d1f] leading-snug">
                      {tool.title}
                    </h3>
                    <span className="shrink-0 text-[10px] font-semibold px-2 py-0.5 bg-[#f5f5f7] border border-[#e0e0e0] text-[#7a7a7a] rounded-full whitespace-nowrap">
                      בקרוב
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-[#1d1d1f] tracking-tight">למדו איך לצמוח</h2>
              <p className="text-sm text-[#7a7a7a] mt-1">מדריכים פרקטיים שנכתבו לטייסים ולעסקים</p>
            </div>
          </div>
            ...
            {GUIDES.map((guide) => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-[11px] text-[#7a7a7a]">{guide.readTime} קריאה</span>
                </div>
                <div>
                  <h3 className="text-[16px] font-bold text-[#1d1d1f] mb-1.5 leading-snug">
                    {guide.title}
                  </h3>
                  <p className="text-[13px] text-[#7a7a7a] leading-relaxed">
                    {guide.description}
                ...
                <div className="mt-auto pt-2 border-t border-[#e0e0e0]">
                  <span className="text-[12px] font-medium text-[#7a7a7a] flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#e0e0e0] inline-block" />
                    בקרוב
                  </span>
                </div>
              </div>
      ...
      {/* ── Final CTA ── */}
      <section className="relative bg-[#272729] py-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <p className="text-[11px] font-semibold tracking-[0.22em] text-[#0066cc] uppercase mb-5">
            הצטרפו לאלטיב
          </p>
          <h2 className="text-3xl sm:text-[2.6rem] font-semibold text-white leading-[1.05] tracking-[-0.02em] mb-5">
            רוצים להופיע באלטיב?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/add-listing"
              className="px-7 py-3.5 bg-[#0066cc] hover:bg-[#1650e8] text-white font-bold text-[14px] rounded-full transition-colors"
            >
              צור פרופיל עסקי
            </Link>
            <Link
              href="/contact"
              className="px-7 py-3.5 border border-white/20 hover:border-white/40 hover:bg-white/5 text-white font-semibold text-[14px] rounded-full transition-colors"
            >
              דברו איתנו
            </Link>
          </div>
