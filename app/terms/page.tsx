  ...
  return (
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-8 text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">3. דיוק המידע</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">5. ספקים רשומים</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">7. שינויים בתנאים</h2>
          <p>
