...
export interface ClassificationEvidence {
  categorySlug: string
  evidence: string   // which terms triggered the match
  source?: string    // field the match came from (e.g. 'name', 'services')
}
...
export interface EnrichedListing extends Listing {
  ...
  // Multi-service discoverability — generated by enrich-listings.ts
  // A listing appears on a category page when categorySlug OR secondaryCategorySlugs matches.
  secondaryCategorySlugs?: string[]
  capabilities?: string[]               // machine-readable capability slugs (e.g. 'thermal-inspection')
  buyerIntentTags?: string[]            // Hebrew display tags for buyers (e.g. 'בדיקות תרמיות')
  classificationEvidence?: ClassificationEvidence[]  // why each secondary category was assigned
